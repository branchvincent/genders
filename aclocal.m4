...
m4_include([config/ac_cplusplus_extensions.m4])
m4_include([config/ac_debug.m4])
m4_include([config/ac_extension_destdir.m4])
m4_include([config/ac_genders_file.m4])
m4_include([config/ac_java_extensions.m4])
m4_include([config/ac_perl_extensions.m4])
m4_include([config/ac_perl_site_arch.m4])
m4_include([config/ac_perl_vendor_arch.m4])
m4_include([config/ac_python_extensions.m4])
